      ...
      <main className="px-4 py-6 space-y-6 animate-fadeIn">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm">
          ...
          <div className="space-y-3 mb-4">
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="font-medium text-gray-900">
                  ...
                  <span className="text-xs text-gray-500 ml-1">
                    NutriScore {product.scoreBreakdown.nutriScoreGrade}
                  </span>
                </span>
              </div>
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${product.scoreBreakdown.nutritionalQuality}%`,
                    backgroundColor: product.scoreBreakdown.nutritionalQuality >= 60 ? '#22c55e' : product.scoreBreakdown.nutritionalQuality >= 30 ? '#f97316' : '#ef4444',
                  }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div
                  className="h-full rounded-full transition-all"
                  style={{
                    width: `${product.scoreBreakdown.additiveQuality}%`,
                    backgroundColor: product.scoreBreakdown.additiveQuality >= 60 ? '#22c55e' : product.scoreBreakdown.additiveQuality >= 30 ? '#f97316' : '#ef4444',
                  }}
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="text-gray-700">Organic Bonus (10%)</span>
                <span className="font-medium text-gray-900">{product.scoreBreakdown.organicBonus > 0 ? 'Yes' : 'No'}</span>
              </div>
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div
                  className="h-full rounded-full transition-all"
                  style={{
                    width: `${product.scoreBreakdown.organicBonus}%`,
                    backgroundColor: product.scoreBreakdown.organicBonus > 0 ? '#22c55e' : '#e5e7eb',
                  }}
                />
              </div>
            </div>
          ...
          {/* Hard cap warning */}
          {product.scoreBreakdown.hasAvoidAdditive && (
            <div className="flex items-center gap-2 px-3 py-2 bg-red-50 rounded-lg mb-4">
              <svg className="w-4 h-4 text-red-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
              <span className="text-xs text-red-700">Score capped at 49 due to additives to avoid</span>
            </div>
          )}
